...
class AdvertisementController extends Controller
{
    ...
    {
        $request->validate([
            'banner_one_image' => ['nullable', 'image', 'max:2048', 'dimensions:width=790,height=690'],
            'banner_one_url' => ['required', 'url'],

            'banner_two_image' => ['nullable', 'image', 'max:2048', 'dimensions:width=780,height=340'],
            'banner_two_url' => ['required', 'url'],

            'banner_three_image' => ['nullable', 'image', 'max:2048', 'dimensions:width=650,height=270'],
            'banner_three_url' => ['required', 'url'],
        ]);

        /** Banner one image handel */
        $imagePath = $this->updateImage($request, 'banner_one_image', 'uploads/advertisement/homepage_banner_section_three_image/part_one');

        /** Banner two image handel */
        $imagePathTwo = $this->updateImage($request, 'banner_two_image', 'uploads/advertisement/homepage_banner_section_three_image/part_two');

        /** Banner three image handel */
        $imagePathThree = $this->updateImage($request, 'banner_three_image', 'uploads/advertisement/homepage_banner_section_three_image/part_three');
        ...
        if (!empty($imagePathThree)) {
            if (isset($request->banner_three_old_image)) {
                unlink($request->banner_three_old_image);
            }
