...
@section('page-title')
    {{ $settings->site_name }} | Update User Address
@endsection
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-md-6">
                                        <div class="wsus__add_address_single">
                                            ...
                                            <input type="text" name="name" value="{{ $address->name ?? old('name') }}"
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div class="wsus__add_address_single">
                                            ...
                                            <input type="email" name="email"
                                                value="{{ $address->email ?? old('email') }}" placeholder="Email"
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div class="wsus__add_address_single">
                                            ...
                                            <input type="text" name="phone"
                                                value="{{ $address->phone ?? old('phone') }}" placeholder="Phone"
                                            ...
                                            <div class="wsus__topbar_select">
                                                <select name="country"
                                                    ...
                                                    @foreach (config('settings.country_list') as $country)
                                                        <option @selected($country === $address->country) value="{{ $country }}">
                                                            {{ $country }}</option>
                                                    @endforeach
                                                </select>
                                                @error('country')
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div class="wsus__add_address_single">
                                            ...
                                            <input type="text" name="state"
                                                value="{{ $address->state ?? old('state') }}" placeholder="State"
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div class="wsus__add_address_single">
                                            ...
                                            <input type="text" name="city"
                                                value="{{ $address->city ?? old('city') }}" placeholder="City"
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div class="wsus__add_address_single">
                                            ...
                                            <input type="text" name="zip" value="{{ $address->zip ?? old('zip') }}"
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div class="wsus__add_address_single">
                                            ...
                                            <input type="text" name="address"
                                                value="{{ $address->address ?? old('address') }}" placeholder="Address"
