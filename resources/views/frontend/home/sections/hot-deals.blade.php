                ...
                <div class="col-xl-12">
                    <div class="wsus__section_header justify-content-start">
                        <div class="monthly_top_filter2 mb-1">
                            ...
                            <button class="me-0" data-filter=".best_product">Best Product</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        @if ($homepage_section_banner_three->banner_one->status == 1)
                            <div class="wsus__single_banner_content banner_1">
                                ...
                                <div class="wsus__single_banner_text">
                                    ...
                                    <h3>smart watch</h3>
                                    <a class="shop_btn"
                                        href="{{ $homepage_section_banner_three->banner_one->banner_url }}">shop
                                        now</a>
                                </div>
                            </div>
                        @endif
                                ...
                                @if ($homepage_section_banner_three->banner_two->status == 1)
                                    <div class="wsus__single_banner_content single_banner_2">
                                        ...
                                        <div class="wsus__single_banner_text">
                                            ...
                                            <h3>kid's fashion</h3>
                                            <a class="shop_btn"
                                                href="{{ $homepage_section_banner_three->banner_two->banner_url }}">shop
                                                now</a>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="wsus__pro_details_text">
                                            ...
                                            @elseif ($product->qty === 0)
                                                <p class="wsus__stock_area"><span class="in_stock bg-danger">stock
                                                        out</span>
                                                    ({{ $product->qty }}
                                                    item)
                                                </p>
