                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <form class="shopping-cart-form">
                                                        ...
                                                        <input name="qty" type="hidden" min="1"
                                                            max="100" value="1" />
                                                        <button class="add_cart border-0" type="submit">add to
                                                            cart</button>
                                                    </form>
                                                </div>
                                            </div>
                            ...
                            "
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <a class="wsus__pro_name"
                                                        href="{{ route('product-detail', $product->slug) }}">{{ limitText($product->name, 40) }}</a>
                                                    @if (checkDiscount($product))
                                                        <p class="wsus__price">
                                                            {{ $settings->currency_icon . $product->offer_price }}
                                                            <del>{{ $settings->currency_icon . $product->price }}</del>
                                                    ...
                                                    @else
                                                        <p class="wsus__price">
                                                            {{ $settings->currency_icon . $product->price }}</p>
                                                    @endif
                                                    <p class="list_description">{!! limitText($product->short_description, 185) !!}</p>

                                                    <form class="shopping-cart-form">
                                                        {{-- Add To Card Hidden Content End --}}
                                                        <input type="hidden" name="product_id"
                                                            value="{{ $product->id }}">
                                                        @foreach ($product->variants as $variant)
                                                            <select class="d-none" name="variants_items[]">
                                                        ...
                                                        {{-- Add To Card Hidden Content Start --}}
                                                        <ul class="wsus__single_pro_icon">
