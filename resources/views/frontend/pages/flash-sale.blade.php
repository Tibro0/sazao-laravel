            ...
            <div class="wsus__offer_details_area">
                ...
                <div class="row">
                    @foreach ($flashSaleItems as $item)
                        @php
                            $product = App\Models\Product::with(['category', 'productImageGalleries'])->find(
                                $item->product_id,
                            );
                        @endphp
...
@push('model')
    ...
    @foreach ($flashSaleItems as $item)
        @php
            $product = App\Models\Product::with(['category', 'productImageGalleries'])->find($item->product_id);
        @endphp
