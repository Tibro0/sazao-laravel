                    ...
                    <div class="wsus__pro_page_bammer vendor_det_banner">
                        ...
                        <div class="wsus__pro_page_bammer_text wsus__vendor_det_banner_text">
                            <div class="wsus__vendor_text_center">
                                ...
                                <a href="callto:{{ $vendor->phone }}"><i class="far fa-phone-alt" aria-hidden="true"></i>
                                    {{ $vendor->phone }}</a>
                                <a href="mailto:{{ $vendor->email }}"><i class="far fa-envelope" aria-hidden="true"></i>
                                    {{ $vendor->email }}</a>
                                <p class="wsus__vendor_location"><i class="fal fa-map-marker-alt" aria-hidden="true"></i>
                                    {{ $vendor->address }}</p>
                                <ul class="d-flex">
                                    <li><a class="facebook" href="{{ $vendor->fb_link }}"><i class="fab fa-facebook-f"
                                                aria-hidden="true"></i></a></li>
                                    <li><a class="twitter" href="{{ $vendor->tw_link }}"><i class="fab fa-twitter"
                                                aria-hidden="true"></i></a></li>
                                    <li><a class="instagram" href="{{ $vendor->insta_link }}"><i class="fab fa-instagram"
                                                aria-hidden="true"></i></a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-8">
                    <div class="row">
                            ...
                            <div class="wsus__product_topbar">
                                <div class="wsus__product_topbar_left">
                                    <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        <button
                                            class="nav-link {{ session()->has('vendor_product_list_style') && session()->get('vendor_product_list_style') === 'grid' ? 'active' : '' }} {{ !session()->has('vendor_product_list_style') ? 'active' : '' }} list-view"
                                        ...
                                        <button
                                            class="nav-link {{ session()->has('vendor_product_list_style') && session()->get('vendor_product_list_style') === 'list' ? 'active' : '' }} list-view"
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade {{ session()->has('vendor_product_list_style') && session()->get('vendor_product_list_style') === 'grid' ? 'show active' : '' }} {{ !session()->has('vendor_product_list_style') ? 'show active' : '' }}"
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <form class="shopping-cart-form">
                                                        ...
                                                        <input name="qty" type="hidden" min="1"
                                                            max="100" value="1" />
                                                        <button type="submit" class="add_cart border-0">add to
                                                            cart</button>
                                                    </form>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade {{ session()->has('vendor_product_list_style') && session()->get('vendor_product_list_style') === 'list' ? 'show active' : '' }}"
                                                    ...
                                                    <ul class="wsus__single_pro_icon">
                                                        ...
                                                        <form class="shopping-cart-form">
                                                            ...
                                                            <input name="qty" type="hidden" min="1"
                                                                max="100" value="1" />
                                                            <button type="submit"
                                                                class="add_cart border-0 me-2 rounded">add to
                                                                cart</button>
                                                        </form>
    ...
    <script>
        $(document).ready(function() {
            $('.list-view').on('click', function() {
                ...
                $.ajax({
                    method: "GET",
                    url: "{{ route('change-vendor-product-list-view') }}",
                    data: {
                        style: style
                    },
