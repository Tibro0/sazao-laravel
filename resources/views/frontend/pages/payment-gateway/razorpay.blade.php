<div class="tab-pane fade {{ Session::has('frontend_payment_tab_list_style') && Session::get('frontend_payment_tab_list_style') == 'razorpay' ? 'show active' : '' }}" id="v-pills-razorpay" role="tabpanel" aria-labelledby="v-pills-home-tab">
    <div class="row">
