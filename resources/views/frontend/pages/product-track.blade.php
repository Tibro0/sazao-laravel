...
@section('page-title')
    {{ $settings->site_name }} | Track Order
@endsection
            ...
            <div class="wsus__track_area">
                    ...
                    <div class="col-xl-5 col-md-10 col-lg-8 m-auto">
                        <form action="{{ route('product-tracking.index') }}" method="GET" class="tack_form">
                            ...
                            <div class="wsus__track_input">
                                <label class="d-block mb-2">Invoice ID<span class="text-danger">*</span></label>
                                <input type="number" name="tracker" value="{{ @$order->invoice_id }}"
                                    placeholder="125463">
                            </div>
                ...
                @if (isset($order))
                    <div class="row">
                        ...
                        @if (
                            @$order->order_status === 'processed_and_ready_to_ship' ||
                                ...
                                @$order->order_status === 'delivered') check_mark @endif">
                                        order Processing</li>
                                    <li
                                        class="icon_three @if (@$order->order_status === 'out_for_delivery' || @$order->order_status === 'delivered') check_mark @endif
                                ">
                                        on the way</li>
                        ...
                        <div class="col-xl-12">
                            <a href="{{ route('home') }}" class="common_btn"><i class="fas fa-chevron-left"></i> back to
                                home</a>
                        </div>
                    </div>
                @endif
