    ...
    <section id="wsus__product_details">
        <div class="container">
            <div class="wsus__details_bg">
                <div class="row">
                    <div class="col-xl-4 col-md-5 col-lg-5" style="z-index: 10000">
                        ...
                        <div class="wsus__details_bg">
                            <ul class="nav nav-pills mb-3" id="pills-tab3" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link {{ Session::has('frontend_product_details_tab_list_style') && Session::get('frontend_product_details_tab_list_style') == 'description' ? 'active' : '' }} {{ !Session::has('frontend_product_details_tab_list_style') ? 'active' : '' }} list-view"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link {{ Session::has('frontend_product_details_tab_list_style') && Session::get('frontend_product_details_tab_list_style') == 'vendor-info' ? 'active' : '' }} list-view"
                                        data-id="vendor-info" id="pills-contact-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-contact" type="button" role="tab"
                                        aria-controls="pills-contact" aria-selected="false">Vendor Info</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link {{ Session::has('frontend_product_details_tab_list_style') && Session::get('frontend_product_details_tab_list_style') == 'reviews' ? 'active' : '' }} list-view"
                                        data-id="reviews" id="pills-contact-tab2" data-bs-toggle="pill"
                                        data-bs-target="#pills-contact2" type="button" role="tab"
                                        aria-controls="pills-contact2" aria-selected="false">Reviews</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent4">
                                <div class="tab-pane fade {{ Session::has('frontend_product_details_tab_list_style') && Session::get('frontend_product_details_tab_list_style') == 'description' ? 'show active' : '' }} {{ !Session::has('frontend_product_details_tab_list_style') ? 'show active' : '' }}"
                                ...
                                <div class="tab-pane fade {{ Session::has('frontend_product_details_tab_list_style') && Session::get('frontend_product_details_tab_list_style') == 'vendor-info' ? 'show active' : '' }}"
                                ...
                                <div class="tab-pane fade {{ Session::has('frontend_product_details_tab_list_style') && Session::get('frontend_product_details_tab_list_style') == 'reviews' ? 'show active' : '' }}"
                                                                ...
                                                                <form action="{{ route('user.review.create') }}"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xl-12">
                                                                            <div class="col-xl-12">
                                                                                <div class="wsus__single_com">
                                                                                    <textarea name="review" cols="3" rows="3" placeholder="Write your review"
                                                                                        class="mb-0 @error('review') border border-danger @enderror"></textarea>
                                                                                    @error('review')
                                                                        ...
                                                                        <span class="text-danger mt-3 mb-2">(width:380px,
                                                                            height:356px) 2MB Maximum</span>
    ...
    <script>
        $(document).ready(function() {
            $('.list-view').on('click', function() {
                ...
                $.ajax({
                    method: "GET",
                    url: "{{ route('frontend-product-details-tab-list-style') }}",
                    data: {
                        style: style
                    },
