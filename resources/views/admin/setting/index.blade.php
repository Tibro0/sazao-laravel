                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link mb-2 list-view {{ Session::has('admin_general_setting_list_style') && Session::get('admin_general_setting_list_style') == 'section_one' ? 'active' : '' }} {{ !Session::has('admin_general_setting_list_style') ? 'active' : '' }}"
                                    data-id="section_one" id="v-pills-home-tab" data-bs-toggle="pill"
                                    href="#general-setting" role="tab" aria-controls="v-pills-home"
                                    aria-selected="true">General Setting</a>
                                <a class="nav-link mb-2 list-view {{ Session::has('admin_general_setting_list_style') && Session::get('admin_general_setting_list_style') == 'section_two' ? 'active' : '' }}"
