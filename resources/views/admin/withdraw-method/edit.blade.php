...
@section('page-title')
    {{ $settings->site_name }} | Update Withdraw Methods
@endsection
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Update Withdraw Methods</h4>
                        <div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="description" id="elm1" placeholder="Description"
                                    class="form-control @error('description') is-invalid @enderror">{!! old('description') ?? $method->description !!}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
