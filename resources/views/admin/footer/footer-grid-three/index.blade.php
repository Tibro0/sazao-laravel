            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">All Footer Grid Three</h4>
                        <div>
                            <button type="button" class="btn btn-outline-primary waves-effect waves-light px-5"
                                data-bs-toggle="modal" data-bs-target="#myModal">Footer Grid Three Title</button>
                            <a href="{{ route('admin.footer-grid-three.create') }}"
                ...
                <div class="card-body">
                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            @foreach ($footerGridThrees as $item)
                                <tr>
                                    ...
                                    <td width="100">
                                        ...
                                        <a href="{{ route('admin.footer-grid-three.destroy', $item->id) }}" id="delete"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Footer Grid Three Title</h5>
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="title"
                                    value="{{ old('title') ?? @$footerTitle->footer_grid_three_title }}" placeholder="Title"
