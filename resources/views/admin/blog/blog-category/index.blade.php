            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('admin.blog-category.create') }}" class="btn btn-primary px-5 rounded">Create New</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($blogCategories as $item)
                                <tr>
                                    ...
                                    <td width="100">
                                        <a href="{{ route('admin.blog-category.edit', $item->id) }}" class="btn btn-primary"><i
