<div class="tab-pane fade {{ Session::has('admin_advertisement_list_style') && Session::get('admin_advertisement_list_style') == 'section_four' ? 'show active' : '' }}"
    id="home-page-banner-section-four" role="tabpanel" aria-labelledby="v-pills-profile-tab">
    <form action="{{ route('admin.homepage-banner-section-four') }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-12">
                <label>Banner Image <span class="text-danger">(width:1650px, height:381px) 2MB Maximum</span></label>
            ...
            <div class="col-md-12">
                ...
                <input type="text" name="banner_url"
                    value="{{ @$homepage_section_banner_four->banner_one->banner_url }}" placeholder="Banner Url"
