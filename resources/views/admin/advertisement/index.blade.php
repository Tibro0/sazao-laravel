                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <a class="nav-link mb-2 list-view {{ Session::has('admin_advertisement_list_style') && Session::get('admin_advertisement_list_style') == 'section_six' ? 'active' : '' }}"
                                    data-id="section_six" id="v-pills-home-tab" data-bs-toggle="pill"
                                    href="#cart-page-banner" role="tab" aria-controls="v-pills-home"
                                    aria-selected="true">Cart Page Banner</a>
                            </div>
                        </div>
                        <div class="col-md-10">
